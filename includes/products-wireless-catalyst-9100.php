                                ...
                                <div class="portfolio-static-desc">
                                    ...
                                    <h3 align="center">Cisco Catalyst 9105 Wi-Fi 6 access point</h3><br>
                                        <ul>
                                           ...
                                           <li>Modelos de montaje en techo y montaje en pared</li>
                                        </ul>
                                </div>					
                            </div><!--/ grid end -->
                        </div><!--/ item 1 end -->
                                ...
                                <div class="portfolio-static-desc">
                                    ...
                                    <h3 align="center">Cisco Catalyst 9115 Wi-Fi 6 access point</h3><br>
                                        <ul>
                                         ...
                                         <li>Admite OFDMA y MU-MIMO</li>
                                         <li>Antena interna y externa</li>
                                        </ul>
                                </div>					
                            </div><!--/ grid end -->
                        </div><!--/ item 2 end -->
                                ...
                                <div class="portfolio-static-desc">
                                    ...
                                    <h3 align="center">Cisco Catalyst 9120 Wi-Fi 6 access point</h3><br>
                                        <ul>
                                         ...
                                         <li>Asignación de radio flexible de Cisco y tecnología Cisco CleanAir</li>
                                         <li>Capacidades de captura de firma RF</li>
                                        </ul>
                                </div>					
                            </div><!--/ grid end -->
                        </div><!--/ item 4 end -->
                                ...
                                <div class="portfolio-static-desc">
                                    ...
                                    <h3 align="center">Cisco Catalyst 9130 Wi-Fi 6 access point (pedido pendiente)</h3><br>
                                        <ul>
                                         ...
                                         <li>Asignación de radio flexible de Cisco y tecnología Cisco CleanAir</li>
                                         <li>Controlador inalámbrico integrado</li>
                                        </ul>
                                </div>					
                            </div><!--/ grid end -->
                        </div><!--/ item 6 end -->

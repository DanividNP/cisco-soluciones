    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h3 class="title-border">Punto de acceso de placa de pared de radio dual Cisco WAP361 Wireless-AC/N con PoE</h3>
                <h5>Conectividad Wireless-AC de clase empresarial de alto rendimiento, fácil de implementar y altamente segura</h5>
                <center> <img class="img-responsive" src="images/Wireless/WAP361.png" alt=""></center>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <p align='justify'><strong>Punto de acceso inalámbrico Cisco WAP361 IEEE 802.11ac 1,20 Gbit/s<<br>
                                    5 GHz</strong></p>
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <p align='justify'>#WAP361-A-K9-NA<br>
                                        <strong>
                                        </strong></p>
                                </div>
                            </div>
